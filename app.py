...
pairs =[
        ...
        ['my name is (.*)| (.*)שמי',['''hi %1 how can i help you?😊 choose the below optoions for the quire
         1.for buy a smartphone(enter 1) 
         2.for sell the smartphone(enter 2) 
         3.for customer service(enter 3)''']],
        ['(hi|hello|hey|holla|היי|שלום)',['''hey there how can i help you?😊 
        choose the below optoions for the quires 
        1.for buy a smartphone(enter 1) 
        2.for sell the smartphone(enter 2) 
        3.for customer service(enter 3)''']],
        ...
        ['(4|אַחֵר|other|other quires)', ['''choose the below optoions for the quires  
        1.for buy a smartphone(enter 1) 
        2.for sell the smartphone(enter 2) 
        3.for customer service(enter 3)''']],
        ...
        ['(.*)', ['''hey, choose the below optoions for the quires
         1.for buy a smartphone(enter 1) 
         2.for sell the smartphone(enter 2) 
         3.for customer service(enter 3)''']]
        ]
